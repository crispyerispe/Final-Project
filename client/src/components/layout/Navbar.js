  ...
  return (
    <Fragment>
      <div className="headertop-wrap">
        <nav id="menuNav">
          <div className="header websitelogo section" id="Website Logo (White)">
            <div className="widget Header" data-version="1" id="Header1">
              <div id="head-inner">
                <a href="#" style={{ display: "block" }}>
                  <img
                    alt="Heather Template"
                    height="120px; "
          ...
          <div className="header mobilelogo section" id="Mobile Logo (Black)">
          ...
          <div className="topbar">
            <div className="rapper">
              <div className="lefttop section" id="Menubar">
